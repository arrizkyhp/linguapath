...
export default function Sidebar({ level, xp, streak, minimized, onToggle }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "fixed left-0 top-0 h-screen bg-[#0f0f0f] flex flex-col z-40 transition-all duration-300",
        minimized ? "w-16" : "w-60",
      )}
    >
      {/* Header with toggle */}
